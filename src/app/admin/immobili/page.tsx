...
function getLocationBadge(property: Property) {
  ...
  if (property.location_mode === 'precise') {
    return {
      ...
      className:
        'admin-location-badge-precise border-emerald-400/30 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300',
    }
  }
  ...
  if (property.location_mode === 'comune_center') {
    return {
      ...
      className: 'admin-location-badge-common border-sky-400/30 bg-sky-500/10 text-sky-300',
    }
  }
