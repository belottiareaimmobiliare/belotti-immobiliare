    ...
    <main className="min-h-screen bg-[var(--site-bg)] text-[var(--site-text)] transition-colors duration-300">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          ...
          {/* map wallpaper: alto visibile, sotto già in sparizione */}
          <div
            className="absolute right-[-8%] top-0 h-[760px] w-[90%] bg-cover bg-right-top bg-no-repeat opacity-[0.30]"
            style={{
          ...
          {/* fade da sinistra */}
          <div className="absolute inset-y-0 left-0 w-[64%] bg-gradient-to-r from-[#020817] via-[#020817]/97 via-[72%] to-transparent" />

          {/* fade basso forte, anticipato */}
          <div className="absolute left-0 right-0 top-[340px] h-[520px] bg-gradient-to-b from-transparent via-[#020817]/88 via-[38%] to-[#020817]" />

          {/* chiusura ulteriore sul fondo della sezione */}
          <div className="absolute bottom-0 left-0 right-0 h-[260px] bg-gradient-to-t from-[#020817] via-[#020817]/98 to-transparent" />

          {/* fade angolo basso sx */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(2,8,23,0.98)_0%,rgba(2,8,23,0.55)_24%,transparent_54%)]" />

          {/* fade angolo alto sx */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(2,8,23,0.84)_0%,rgba(2,8,23,0.22)_24%,transparent_44%)]" />
          ...
          {/* glow morbido */}
          <div className="absolute right-[-10%] top-[-40px] h-[520px] w-[520px] rounded-full bg-blue-500/10 blur-3xl" />
        </div>
            ...
            <div className="theme-panel mb-8 flex flex-col gap-4 rounded-[28px] border p-5 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[var(--site-text-muted)]">
                  Puoi continuare ad affinare i risultati con i filtri disponibili,
                  oppure modificare la zona direttamente sulla mappa.
                </p>
              </div>
